document.addEventListener("DOMContentLoaded", function () {
    ...
    function calculatePoints() {
        ...
        total += parseInt(document.getElementById("rocketOrbit").value) * 12;
        total += parseInt(document.getElementById("rocketFlight").value) * 5;
        total += parseInt(document.getElementById("satelliteCorrect").value) * 28;
        total += parseInt(document.getElementById("satelliteWrong").value) * 14;
        total += parseInt(document.getElementById("spaceDebris").value) * 15;
        total += parseInt(document.getElementById("astronautSafety").value) * 9;
        total += parseInt(document.getElementById("barrierIntact").value) * 7;
